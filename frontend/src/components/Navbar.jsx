      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center space-x-3 group">
            ...
            >
              <img src={logo} alt="Home Rentals logo" className="w-6 h-6" />
            </motion.div>
          ...
          <div className="hidden md:flex items-center space-x-8">
            <NavLinks currentPath={location.pathname} isLoggedIn={isLoggedIn} />
                  ...
                  <AnimatePresence>
                    {isDropdownOpen && (
                      ...
                      >
                        ...
                        <Link
                          to="/dashboard"
                          className="block px-4 py-2 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-600 flex items-center space-x-2 transition-colors"
                        >
...
const NavLinks = ({ currentPath, isLoggedIn }) => {
  const navLinks = [
    { name: "Home", path: "/", icon: Home },
    { name: "Properties", path: "/properties", icon: Search },
    { name: "About Us", path: "/about", icon: Users },
    { name: "Contact", path: "/contact", icon: MessageCircle },
    ...(isLoggedIn ? [{ name: "Dashboard", path: "/dashboard", icon: User }] : []),
  ];
