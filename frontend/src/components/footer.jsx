...
const socialLinks = [
  { icon: Twitter, href: 'https://x.com/home', label: 'Twitter', color: 'bg-[#1DA1F2]', hoverColor: 'hover:bg-[#1DA1F2]/90' },
  { icon: Facebook, href: 'https://www.facebook.com/', label: 'Facebook', color: 'bg-[#1877F2]', hoverColor: 'hover:bg-[#1877F2]/90' },
  { icon: Instagram, href: 'https://www.instagram.com/', label: 'Instagram', color: 'bg-gradient-to-tr from-[#fd5949] via-[#d6249f] to-[#285AEB]', hoverColor: 'hover:opacity-90' },
  { icon: Github, href: 'https://github.com/Rijon63?tab=repositories', label: 'GitHub', color: 'bg-[#333]', hoverColor: 'hover:bg-gray-800' },
];
...
const contactInfo = [
  { 
    icon: MapPin, 
    text: 'Dakshin Dhoka,Kathmandu, Nepal',
    href: 'https://www.google.com/maps/place/KTM+CTY+-+Dakshin+Dhoka/@27.7222047,85.3842683,17z/data=!3m1!4b1!4m6!3m5!1s0x39eb1b3562866287:0x269dfe216c6f68b0!8m2!3d27.7222047!4d85.3868432!16s%2Fg%2F11ssfnc_9f?entry=ttu&g_ep=EgoyMDI1MDYxMS4wIKXMDSoASAFQAw%3D%3D', 
  },
  { 
    icon: Phone, 
    text: '+977 9866313430',
    href: 'tel:+9779866313430'
  },
  { 
    icon: Mail, 
    text: 'rijonadhikari2@gmail.com',
    href: 'mailto:rijonadhikari2@gmail.com' 
  },
];
      ...
      <div className="bg-gray-100 border-t border-gray-200 py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-600 mb-4 md:mb-0 text-center md:text-left">
            © {new Date().getFullYear()} Home Rentals. All Rights Reserved.
          </p>
