        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <label htmlFor="ward" className="block text-sm font-medium text-gray-700">Ward Number</label>
                <select
                  id="ward"
                  name="ward"
                  value={formData.ward}
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div>
                <label htmlFor="area" className="block text-sm font-medium text-gray-700">Land Area (Square Feet)</label>
                <input
                  type="number"
                  id="area"
                  name="area"
