export const getSchedulingEmailTemplate = (appointment, date, time, notes) => `
  <div style="max-width: 600px; margin: 20px auto; font-family: 'Arial', sans-serif; line-height: 1.6;">
    ...
    <div style="background: linear-gradient(135deg, #2563eb, #1e40af); padding: 40px 20px; border-radius: 15px 15px 0 0; text-align: center;">
      ...
      <p style="color: #ffffff; opacity: 0.9; margin: 10px 0 0 0; font-size: 16px;">Home Rentals Property Viewing</p>
    </div>
    ...
    <div style="background: #ffffff; padding: 40px 30px; border-radius: 0 0 15px 15px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.1);">
      ...
      <div style="margin-top: 30px; padding: 20px; background: #f8fafc; border-radius: 8px;">
        ...
        <p style="margin: 0; color: #4b5563;">
          ...
          <br>
          📧 <a href="mailto:rijonadhikari2@gmail.com" style="color: #2563eb; text-decoration: none;">rijonadhikari2@gmail.com</a>
          <br>
          📞 <a href="tel:+1234567890" style="color: #2563eb; text-decoration: none;">977 9866313430</a>
        </p>
      </div>
    </div>
...
<div style="max-width: 600px; margin: 20px auto; font-family: 'Arial', sans-serif; line-height: 1.6;">
  <!-- Header with Background -->
  <div style="background: linear-gradient(135deg, #2563eb, #1e40af); padding: 40px 20px; border-radius: 15px 15px 0 0; text-align: center;">
    <h1 style="color: #ffffff; margin: 0; font-size: 28px; font-weight: 700;">Welcome to Home Rentals!</h1>
...
export const getPasswordResetTemplate = (resetUrl) => `
  <div style="max-width: 600px; margin: 20px auto; font-family: 'Arial', sans-serif; line-height: 1.6;">
    ...
    <div style="background: linear-gradient(135deg, #2563eb, #1e40af); padding: 40px 20px; border-radius: 15px 15px 0 0; text-align: center;">
      ...
      <p style="color: #ffffff; opacity: 0.9; margin: 10px 0 0 0; font-size: 16px;">Home Rentals Account Security</p>
    </div>
    ...
    <div style="background: #ffffff; padding: 40px 30px; border-radius: 0 0 15px 15px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.1);">
      ...
      <div style="background: #f0f7ff; border-left: 4px solid #2563eb; padding: 20px; border-radius: 8px; margin-bottom: 30px;">
        ...
        <p style="margin: 8px 0; color: #374151;">
          We received a request to reset your password for your Home Rentals account. For your security, this link will expire in 10 minutes.
        </p>
      </div>
